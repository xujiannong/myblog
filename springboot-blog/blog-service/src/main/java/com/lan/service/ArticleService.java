...
import com.lan.domain.Article;
import com.lan.mapper.ArticleMapper;
import com.lan.mapper.TagsMapper;
...
public class ArticleService {
    ...
    public int addNewArticle(Article article) {
        ...
        if (article.getId() == -1) {
            ...
            //设置当前用户
            article.setUid(UserUtils.getCurrentUser().getId().longValue());
    ...
    public List<Article> getArticleByState(Integer state, Integer page, Integer count, String keywords) {
        ...
        Long uid = UserUtils.getCurrentUser().getId().longValue();
...
//    }
    ...
    public List<String> getCategories() {
        return articleMapper.getCategories(UserUtils.getCurrentUser().getId().longValue());
    }
    ...
    public List<Integer> getDataStatistics() {
        return articleMapper.getDataStatistics(UserUtils.getCurrentUser().getId().longValue());
    }
}
